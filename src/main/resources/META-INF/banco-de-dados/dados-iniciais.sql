...
insert into pedido (id, client_id, data_criacao, total, status) values (1, 1, sysdate(), 998.0, 'AGUARDANDO');
insert into pedido (id, client_id, data_criacao, total, status) values (2, 1, sysdate(), 499.0, 'AGUARDANDO');
